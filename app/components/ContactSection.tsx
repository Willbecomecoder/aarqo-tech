...
export default function ContactSection() {
  const [formData, setFormData] = useState({
    ...
    email: "",
    company: "",
    service: "AI Calling Agent & Voice Bot",
    details: "",
  });
        ...
        <div className="bg-[#0B0F19]/80 backdrop-blur-2xl border border-white/10 p-8 sm:p-12 rounded-3xl shadow-[0_0_50px_rgba(0,240,255,0.15)] relative z-20">
          {status === "success" ? (
            <div className="py-12 text-center space-y-4">
              ...
              <h3 className="text-2xl font-black text-white uppercase">Message Sent Successfully!</h3>
              <p className="text-gray-300 text-sm max-w-md mx-auto">
                Thank you! Your message has been sent successfully. We will get back to you soon.
              </p>
              <button
                onClick={() => setStatus("idle")}
                className="mt-4 px-6 py-2 rounded-full bg-white/10 text-white font-bold text-xs uppercase hover:bg-white/20 transition-colors"
              >
